...
export default function PageHeader({ title }: PageHeaderProps) {
  ...
  return (
    <div className='px-[15px] 3xl:px-[26px]'>
      <div
        className='mb-5 flex flex-col gap-5 rounded-md bg-widget p-5 shadow-default transition-shadow duration-300 md:mb-[26px] md:!p-[26px] lg:flex-row lg:items-center
    lg:gap-4 lg:!py-5'
      >
